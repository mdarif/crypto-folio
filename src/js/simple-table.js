  ...
  return (
    <Paper className={classes.root}>
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            <CustomTableCell>Pair</CustomTableCell>
            <CustomTableCell numeric>Quantity</CustomTableCell>
            <CustomTableCell numeric>Price per unit</CustomTableCell>
            <CustomTableCell numeric>Amount</CustomTableCell>
            <CustomTableCell numeric>Fees</CustomTableCell>
            <CustomTableCell numeric>Total Amount</CustomTableCell>
            <CustomTableCell numeric>Average Price</CustomTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {data.map(n => {
